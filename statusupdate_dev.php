...
$assigned_by=substr($assigned_by1,0,4);

$q = "select * from admin where first_name like '%". $assigned_by."%' ";
//echo $q;
$query=mysql_query("select * from admin where first_name like '%". $assigned_by."%' ");
$q1=mysql_fetch_array($query);
$to = $q1['email']. ",developer@ccbst.ca";
...
$admin2=$_POST['pwd'];
$sql=mysql_query("update tasks set status='$newstatus',`temporary_status_date`='$today' where task_id='$taskid'");
...
$message .= ".\r\n";
$message .= "If the task is not completed yet please change the status to open again.Please let us know if you are unable to do so.";
